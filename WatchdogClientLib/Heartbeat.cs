	...
	public class Heartbeat
	{
		...
		public void SendHeartbeat()
		{
			...
			if (_stopwatchHeartBeat.ElapsedMilliseconds > 25)
			{
				...
				SendCommand(Commands.Heartbeat, _processId);
			}
		}

		public void RequestKill()
		{
			SendCommand(Commands.RequestKill, _processId);
		}

		public void RequestKill(uint sec)
		{
			SendCommand(Commands.RequestKill, _processId, sec);
		}

		public void RequestKill(TimeSpan time)
		{
			SendCommand(Commands.RequestKill, _processId, time.TotalSeconds);
		}
